...
### Local
    ...
    // Run local environment. Meant with usage with runebase-exchange-ui dev server.
...
You can specify certain attributes in a `.env` file at the root folder. `RUNEBASE_PATH` in `.env` will take priority over the flag `--runebasepath=/path/to/bin`.
    ...
    DATA_DIR=/path/to/runebase-exchange/data/dir
...
- Go to the GraphQL Playground at `exchange.runebase.io:8989/graphql`
...
**Response 200**
    ...
    {
        "0": "500000000"    // Predoshi
    }

### POST /approve
Gives the spender approval to transfer PRED from your wallet address.

**Body**

    {
        "spender": "7cde77dbe43dadea8a707858645f504ca7bf90ad",  // approvee
        "value": "0",                                           // amount to approve in Predoshi
...
**Response 200**
    ...
    {
        "0": "0",
        "remaining": "0"    // Predoshi
    }

### POST /pred-balance
Gets the PRED balance of an address.
...
**Response 200**
    ...
    {
        "0": "31701300000000",
        "balance": "31701300000000" // Predoshi
    }
...
**Response 200**
    ...
    {
        "0": [
            "0",            // 0 Predoshi on index 0
            "100000000",    // 100000000 Predoshi on index 1
            "0",
            "0",
            "0",
            "0",
...
**Response 200**
    ...
    {
        "0": [
            "0",            // 0 Predoshi total on index 0
            "100000000",    // 100000000 Predoshi total on index 1
            "0",
            "0",
            "0",
            "0",
...
### POST /total-pred-value
Gets the total PRED value of a TopicEvent.
